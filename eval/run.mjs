...
const manifest = {schemaVersion:1,experimentId:config.id,config,split:v.split,repeats,caseIds:cases.map(x=>x.id),caseSetHash:hash(cases),provenance:provenance(),startedAt:new Date().toISOString(),orderSeed,dry:v.dry};
