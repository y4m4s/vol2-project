...
The assets listed below are not NaviCom branding and are not covered by any
license that may apply to NaviCom. They are used only to identify supported AI
providers. Their inclusion does not imply sponsorship, endorsement, or an
official partnership.

## GitHub Copilot

- `github-copilot-icon-black.svg`
- `github-copilot-icon-white.svg`
- Source: GitHub Brand Toolkit, `GitHub_Logos.zip`
- Guidelines: https://brand.github.com/brand-identity/copilot

GitHub and GitHub Copilot are trademarks of GitHub, Inc. The official artwork
...
- `icons8-orca-black.png`
- `icons8-orca-white.png`
- Source: https://icons8.com/icon/iAYdQa49uN11/orca
- License and attribution requirements: https://icons8.com/license
